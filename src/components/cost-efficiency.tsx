const CostEfficiency = () => {
	return (
		<div className='hero flex flex-col w-full h-full items-center relative'>
			...
			<span className='animate-link absolute bottom-0 translate-y-1/2 hover:-translate-y-4 transition-all group'>
				<div
					...
					<p
						className='font-extrabold text-8xl mx-auto text-white group-hover:text-primary-l1 transition-all -mt-5 group-hover:text-[108px]'>{2}</p>
					<h3
						className='font-medium text-[28px] leading-[28px] text-white text-center transition-all group-hover:text-[46px] group-hover:leading-[46px] group-hover:text-primary-l1'>Real-Time <br/> Data</h3>
					</div>
				<span
